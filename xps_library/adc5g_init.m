...
for i=0:length(inputs)-1
    ...
    reuse_block(blk, [...
        ...
        'Position', [curr_x 100+i*sample_sep*samples,...
                     curr_x+30 116+i*sample_sep*samples],...
        'Gain', num2str((2^(adc_bit_width)-1)/2.0));
    ...
    reuse_block(blk, [...
        ...
        'Position', [curr_x 100+i*sample_sep*samples,...
                     curr_x+30 116+i*sample_sep*samples],...
        'Bias', num2str((2^(adc_bit_width)-1)/2.0));
    ...
    for j=0:samples-1
        ...
        port_name = clear_name([blk, '_', port_names{i*samples + j + 1}]);
        disp(port_name)
        reuse_block(blk,...
            port_name,...
        ...
        reuse_block(blk, [...
           'conv_', inputs{i+1}, num2str(j)],...
            'xps_library/ADCs/conv', ...
            'Position', [curr_x 100+i*sample_sep*samples+j*sample_sep,...
                         curr_x+80 116+i*sample_sep*samples+j*sample_sep],...
            'bit_width', num2str(adc_bit_width));
    
        add_line(blk, [port_name, '/1'],...
                      ['conv_', inputs{i+1}, num2str(j), '/1']);
        curr_x = curr_x + 160;
        ...
        add_line(blk, ['conv_', inputs{i+1}, num2str(j), '/1'],...
                      [inputs{i+1}, num2str(j), '/1']);
    
        curr_x = curr_x - 600; % undo all x changes
    end
...
sync_name = clear_name([blk, '_', 'sync']);
reuse_block(blk,...
	sync_name,...
    'xbsIndex_r4/Gateway In',...
    'Position', [curr_x 160+i*sample_sep*samples+j*sample_sep,...
